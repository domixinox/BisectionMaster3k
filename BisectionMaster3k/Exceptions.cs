...
namespace BisectionMaster3k
{
    ...
    public static class Exceptions
    {
        ...
        // Bad Function Sygnature
        public const string EBadFunctionSygnature = "8";
        public static string EBadFunctionSygnatureMsg =
          "Proszę korzystać tylko z tych znaków:" +
          $"\r\n{Validator.fAllowedChars}";
      ...
      "Nie dzielimy przez zero"
        ...
        //*****************************************************************************
        public static void vActBadFunctionSygnature()
        {
            isProgramRun = false;
            parent.InputPolynomialErrorMsg(EBadFunctionSygnatureMsg);
        ...
        //*****************************************************************************
        public static void vActCollectionsCountf()
        {
            isProgramRun = false;
            parent.InputPolynomialErrorMsg(ECollectionsCountMsg);
