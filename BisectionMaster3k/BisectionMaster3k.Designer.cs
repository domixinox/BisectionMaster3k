namespace BisectionMaster3k
{
  partial class BisectionMaster3k
  {
    ...
    private void InitializeComponent()
    {
      ...
      numericX2.Minimum = new decimal(new int[] { 1000, 0, 0, int.MinValue });
      ...
      numericX1.Minimum = new decimal(new int[] { 1000, 0, 0, int.MinValue });
